...
gsap.from('.niz_number', {opacity: 0, duration: 3, delay: .7, y: 45, ease:'expo.out', stagger: .2});
gsap.from('.nizz_number', {opacity: 0, duration: 4, delay: .7, y: 35, ease:'expo.out', stagger: .2});
/*Text*/
